...
class InputWriter_OpenFAST(object):
    ...
    def write_MainInput(self):
        ...
        f.write('{:<22} {:<11} {:}'.format(' '.join(['%d'%i for i in np.array(self.fst_vt['Fst']['MirrorRotor'], dtype=int)]), 'MirrorRotor', '- List of rotor rotation directions [1 to NRotors] {0=CCW, 1=CW}\n'))
